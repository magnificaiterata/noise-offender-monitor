...
if __name__ == "__main__":
    model_path = "/home/luma/noise-offender-monitor/models/modelfile.eim"
    audio_file = "/home/luma/noise-offender-monitor/samples/30_One.wav"
    processor = AudioFileProcessor(model_path)
    processor.init_model()
    best_label, best_score = processor.process_audio(audio_file)
    print(f"Most likely category: {best_label} with average score: {best_score:.2f}")
